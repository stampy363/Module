...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label5->Location = System::Drawing::Point(67, 51);
			...
			// label6
			// 
			this->label6->Location = System::Drawing::Point(148, 51);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(58, 18);
			this->label6->TabIndex = 5;
			this->label6->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &MyForm::label6_MouseMove);
			// 
			// MyForm
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(224, 102);
